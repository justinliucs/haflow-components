...
configurations = {
		...
		@ModuleConfiguration(key="predictors",displayName="predictors: a list of predictor variables",pattern = "^(.*)$", type = ModuleConfigurationType.PLAIN_TEXT),
		@ModuleConfiguration(key="types",displayName = "types: a list of predictor variable types (numeric, word, or text)", pattern = "^(.*)$", type = ModuleConfigurationType.PLAIN_TEXT),
