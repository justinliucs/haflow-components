...
public final class TrainLogistic {
  ...
  private static String inforFile;
  ...
  public static void main(String[] args) throws Exception {
    ...
    /*OutputStream out = writeHdfs("");
    PrintWriter pout = new PrintWriter(out, true);//new PrintWriter(file)
    mainToOutput(args,pout);
  ...
  private static boolean parseArgs(String[] args) {
    ...
    Option outputFile = builder.withLongName("output")
            ...
            .withDescription("where to get training data")
            .create();
    Option inforFile = builder.withLongName("infor")
            .withRequired(true)
            .withArgument(argumentBuilder.withName("infor").withMaximum(1).create())
            .withDescription("where to store information about the training")
            .create();
 ...
 /* static BufferedReader open(String inputFile) throws Exception {
  ...
  static OutputStream writeHdfs(String outputFile) throws IOException{
	  Configuration conf = new Configuration();
		FileSystem fs = FileSystem.get(conf);
